...
import com.example.dakiplataformas.model.admin.ProveedorCategoriaVentasProyeccion;
...
""")
    ...
    @Query("SELECT new com.example.dakiplataformas.model.PaymentMethodReportDTO(" +
